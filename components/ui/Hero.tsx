...
//     <section
//       id="home"
//       className="relative lg:min-h-screen flex items-center overflow-hidden bg-black px-5 pt-10 md:pt-30 "
//     >
...
//       <div className="md:grid lg:grid-cols-2 flex flex-col-reverse items-center w-full gap-10  max-w-7xl mx-auto">
//         {/* 🧠 LEFT CONTENT */}
...
//           {/* PREMIUM GOOGLE REVIEWS FLOATING CARD */}
        ...
        //       },
        //     }}
        //     className=" absolute -top-10 md:top-5 -right-3 md:-right-15 z-50 "
        //   >
        //     {/* Glow */}
        ...
        //        bg-black/50  backdrop-blur-2xl  px-2.5 py-1.5 shadow-[0_10px_40px_rgba(0,0,0,0.45)] "
        //     >
        //       {/* Shine Sweep */}
        //       <div
